...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        8 => wire__crate__api__frb__delete_contact_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__frb__get_all_books_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__frb__get_all_contacts_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__frb__get_all_loans_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__frb__get_all_tags_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__frb__get_book_by_id_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__frb__get_contact_by_id_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        16 => wire__crate__api__frb__get_mdns_service_type_impl(ptr, rust_vec_len, data_len),
        17 => wire__crate__api__frb__get_version_impl(ptr, rust_vec_len, data_len),
        18 => wire__crate__api__frb__greet_impl(ptr, rust_vec_len, data_len),
        19 => wire__crate__api__frb__health_check_impl(ptr, rust_vec_len, data_len),
        22 => wire__crate__api__frb__is_mdns_available_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
